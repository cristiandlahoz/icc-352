...
public class EncuestadoService {
  ...
  public Optional<Encuestado> createEncuestado(
      String nombre, String sector, NivelEscolar nivelEscolar) {
  ...
  public Optional<Encuestado> updateEncuestado(
      Long id, String nombre, String sector, NivelEscolar nivelEscolar) {
    if (nombre == null || nombre.trim().isEmpty()) {
      throw new IllegalArgumentException("Name cannot be empty.");
    }
    if (sector == null || sector.trim().isEmpty()) {
