...
cd $GITHUB_REPO/examen-2

./gradlew shadowjar

java -jar $HOME/$GITHUB_REPO/examen-2/app/build/libs/app.jar >$HOME/$GITHUB_REPO/examen-2/app/build/libs/output.log 2>$HOME/$GITHUB_REPO/examen-2/app/build/libs/error.log &
