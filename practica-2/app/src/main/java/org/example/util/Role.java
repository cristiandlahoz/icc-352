...
public enum Role {
    ADMIN(EnumSet.of(
            Permissions.ARTICLE_CREATE, Permissions.ARTICLE_EDIT, Permissions.ARTICLE_DELETE,
            Permissions.COMMENT_CREATE, Permissions.COMMENT_EDIT, Permissions.COMMENT_DELETE,
