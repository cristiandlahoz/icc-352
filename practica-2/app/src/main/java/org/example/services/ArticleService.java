...
public class ArticleService {
    ...
    static {
        articles.put(1L, new Article("Introducción a la Programación en Java",
                ...
                "Theprimeagen", new Date(System.currentTimeMillis() - 10L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(2L, new Article("Guía Básica de Bases de Datos SQL",
                ...
                "", new Date(System.currentTimeMillis() - 20L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(3L, new Article("Cómo Crear una API con Spring Boot",
                ...
                "user1", new Date(System.currentTimeMillis() - 5L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(4L, new Article("Optimización de Código en JavaScript",
                ...
                "user2", new Date(System.currentTimeMillis() - 15L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(5L, new Article("Seguridad en Aplicaciones Web",
                ...
                "user1", new Date(System.currentTimeMillis() - 7L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(6L, new Article("Principios de Diseño de Software",
                ...
                "user2", new Date(System.currentTimeMillis() - 30L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(7L, new Article(
                ...
                "Theprimeagen", new Date(System.currentTimeMillis() - 3L * 24 * 60 * 60 * 1000)));
        ...
        articles.put(8L, new Article("Machine Learning con Python",
                ...
                "user2", new Date(System.currentTimeMillis() - 1L * 24 * 60 * 60 * 1000)));

        ArrayList<Tag> javaTags = new ArrayList<>(Arrays.asList(new Tag("Java"), new Tag("Programación")));
        ArrayList<Tag> sqlTags = new ArrayList<>(Arrays.asList(new Tag("SQL"), new Tag("Bases de Datos")));
        ArrayList<Tag> apiTags = new ArrayList<>(Arrays.asList(new Tag("Spring Boot"), new Tag("API")));
        ArrayList<Tag> anotherTags = new ArrayList<>(Arrays.asList(new Tag("Make"), new Tag("API")));

        articles.get(1L).setTags(javaTags);
        articles.get(2L).setTags(sqlTags);
        articles.get(3L).setTags(apiTags);
        articles.get(7L).setTags(anotherTags);
    }
