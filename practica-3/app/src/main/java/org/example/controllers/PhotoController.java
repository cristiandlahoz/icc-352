...
public class PhotoController extends BaseController {
    ...
    public void getPhotoById(Context ctx) {
        ...
        photoService.getPhotoById(id).ifPresentOrElse(
                ctx::json,
    ...
    public void updatePhoto(Context ctx) {
        Photo myPhoto = ctx.bodyAsClass(Photo.class);
        photoService.updatePhoto(myPhoto).ifPresentOrElse(
    ...
    public void procesarPhotos(@NotNull Context ctx) {
        ctx.uploadedFiles("photo").forEach(uploadedFile -> {
            try {
                ...
                Photo photo = new Photo(uploadedFile.filename(), uploadedFile.contentType(), encodedString);
